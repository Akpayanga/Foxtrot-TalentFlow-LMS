...
export default function ModuleDetail() {
  return (
    <div className="min-h-screen bg-[#FDFDFD]">
      ...
      <main className="mx-auto max-w-[1216px] px-5 md:px-10 py-8">
        {/* Breadcrumbs */}
        <nav className="mb-6 flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-gray-400">
          <Link to="/mylearning" className="hover:text-[#F38821]">MY LEARNING</Link>
          <span className="text-gray-300">&gt;</span>
          <span className="text-gray-400">CONDUCT UX RESEARCH...</span>
          <span className="text-gray-300">&gt;</span>
          <span className="text-[#3341C1]">MODULE 1</span>
        </nav>
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[1fr_340px]">
          ...
          <div className="space-y-10">
            ...
            <header className="space-y-3">
              ...
              <h1 className="text-3xl md:text-4xl font-bold tracking-tight text-[#111827] leading-tight">
                Conduct UX Research and Test Early Concepts
              </h1>
              <p className="text-[10px] font-bold uppercase tracking-widest text-[#3341C1]">MODULE 2 OF 5</p>
            </header>
            ...
            <section className="space-y-5">
              <h3 className="text-[11px] font-bold uppercase tracking-widest text-gray-400">LEARNING RESOURCES</h3>
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between pt-8">
              ...
              <button className="flex items-center justify-center gap-2 rounded-xl bg-[#F38821] px-6 py-3 text-sm font-bold text-white shadow-md shadow-orange-100 transition-all hover:bg-[#e37b1d]">
                Previous Module
            ...
            <footer className="mt-8 flex justify-end gap-8 pb-10">
              {["PRIVACY", "TERMS", "SUPPORT"].map((link) => (
                <button key={link} className="text-[10px] font-bold tracking-widest text-[#F38821] hover:underline">
                  {link}
                </button>
              ))}
            </footer>
