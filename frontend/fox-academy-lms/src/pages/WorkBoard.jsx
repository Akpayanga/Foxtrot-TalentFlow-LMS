            ...
            <header className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-6">
              <div>
                ...
                <p className="text-base font-normal text-[#F38821]">
                  Finesse • Team Forttnt • All tasks across 5 disciplines
                </p>
              </div>
              ...
              <div className="flex bg-orange-50/30 p-1.5 rounded-lg border border-orange-100 w-max">
                ...
                <button
                  ...
                  className="text-[#F38821] px-8 py-2.5 rounded-md text-[10px] font-bold uppercase tracking-widest hover:bg-orange-50 transition"
                >
                  My Tasks
                </button>
              </div>
              ...
              {filters.map((filter) => (
                <button
                  ...
                  className={`whitespace-nowrap px-5 py-2 rounded-full text-[10px] font-bold tracking-wider transition-colors uppercase ${
                    activeFilter === filter
                      ? "bg-[#F38821] text-white shadow-md shadow-orange-200"
