...
router.post("/forgot-password/resend", validate(forgotPasswordSchema), userInstructorAuth.resendForgotPassword);
...
router.get(
	...
	passport.authenticate("google-user-instructor", {
		session: false,
		failureRedirect: `${process.env.FRONTEND_URL || "http://localhost:5173"}/login?oauthError=1`,
	}),
