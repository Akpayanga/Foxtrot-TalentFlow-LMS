...
router.post("/register", requireAuthAndRole("admin"), validate(adminRegisterSchema), adminAuthController.adminRegister);
...
router.get("/google/callback", passport.authenticate("google-admin", { session: false }), adminAuthController.googleAdminLogin);
